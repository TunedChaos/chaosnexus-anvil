...
# Prefer sibling component checkouts SDKs/MacOSX.sdk (CI-only; never subtree-synced to public GitHub trees).
...
# Stage release binaries under artifacts/anvil/ (gitignored).
...
# Copy compiled binaries into artifacts/anvil/ with stable names.
